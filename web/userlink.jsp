...
<% 
    if(session.getAttribute("user")!=null && user.getRole()!=null && user.getRole().equalsIgnoreCase("User")) { 
        if(request.getParameter("songId")!=null) {
            ...
            new SongUserDao().insertSongUser(songuser);    
            request.setAttribute("msg", "Song linked successfully.");
            RequestDispatcher rd = request.getRequestDispatcher("movie.jsp?movieId="+song.getSongMovieId());
